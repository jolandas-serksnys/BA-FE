...
export const IconReceipt = (props: SVGProps<SVGSVGElement>): ReactElement => (
  <svg width={24} height={24} viewBox="0 0 24 24" fill="currentColor" className="icon" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path opacity="0.3" d="M5 19.09H19V4.91003H5V19.09ZM6 7.00003H18V9.00003H6V7.00003ZM6 11H18V13H6V11ZM6 15H18V17H6V15Z" />
